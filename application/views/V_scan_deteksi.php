            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body">
                        ...
                        <hr>
                        <select style="margin-left: 600px;"></select>
                    </div>
                    <br>
                    <div class="panel-footer">
                        <center> <button><a href="<?= base_url('dashboard') ?>">Kembali</a></button> </center>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        var arg = {
            resultFunction: function(result) {
                ...
                var redirect = "<?= base_url() ?>kodeqr/detaildeteksi/";
                $.redirectPost(redirect, {
                    id_pallet: result.code
                });
            }
        };
